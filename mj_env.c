...
*/
char *get_env_variable(info_t *shell_info, const char *var_name)
...
* Return: Always 0.
*/
int set_env_variable(info_t *shell_info)
...
if (_set_env_variable(shell_info,
shell_info->argv[1], shell_info->argv[2]) != 0)
{
return (1);
}
...
* Return: Always 0.
*/
int unset_env_variable(info_t *shell_info)
...
* @shell_info: A pointer to shell_info_t struct containing potential arguments
* Return: Always returns 0.
*/
int populate_env_var_list(info_t *shell_info)
{
if (shell_info == NULL)
{
return (1);
