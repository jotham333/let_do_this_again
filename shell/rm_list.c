 ...
 * The function prints the string in each node, or "(nil)" if the str field is NULL,
 * Return: size of list
 */
 ...
 * It takes a double pointer to the head of the list (head_ptr) and returns void.
 * Return: void
 */
